...
//          this.WriteSymbolIndex(symbols);
        ...
        public void WriteMainFile ()
        {
            ...
            w.WriteLine("<html>\r\n<head>"
                        + "<title>TADS3 Library Reference Manual</title>"
                        + "</head>");
        ...
        public void WriteFileIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Files</title>"
                        + "</head><body>"
                        + "<h2>Files</h2>");
        ...
        public void WriteClassIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Classes</title>"
                        + "</head><body>"
                        + "<h2>Classes</h2>");
            foreach (ClassDef c in this.SymbolTable.Classes)
            {
        ...
        public void WriteActionIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Actions</title>"
                        + "</head><body>"
                        + "<h2>Actions</h2>");
            foreach (ClassDef c in this.SymbolTable.Classes)
            {
        ...
        public void WriteGrammarIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Grammar Rules</title>"
                        + "</head><body>"
                        + "<h2>Grammar&nbsp;Rules</h2>");
...
//            }
        ...
        public void WriteObjectIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Objects</title>"
                        + "</head><body>"
                        + "<h2>Objects</h2>");
            foreach (ObjectDef o in this.SymbolTable.GlobalObjects)
        ...
        public void WriteClassIndex (SourceFile sf)
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"../libref.css\">"
                        + "<title>TADS 3: Index of Classes in "
                        + sf.ShortName + "</title>"
                        + "</head><body>"
                        + "<h2>Classes</h2>");
        ...
        public void WriteMacroIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Macros</title>"
                        + "</head><body>"
                        + "<h2>Macros</h2>");
        ...
        public void WriteEnumIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Enums</title>"
                        + "</head><body>"
                        + "<h2>Enums</h2>");
        ...
        public void WriteTemplateIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Templates</title>"
                        + "</head><body>"
                        + "<h2>Templates</h2>");
        ...
        public void WriteFunctionIndex ()
        {
            ...
            w.WriteLine("<html><head>"
                        + "<link rel=stylesheet type=\"text/css\" "
                        + "href=\"libref.css\">"
                        + "<title>TADS 3: Index of Functions</title>"
                        + "</head><body>"
...
//            s = s.Replace("{{/mod}}", ":</i><br>");
        ...
        private void WriteHtmlFooter (StreamWriter w)
        {
            ...
            w.Write("<div class=ftr>TADS 3 Library Manual<br>"
                    + "Generated on " + now.ToShortDateString());
            if (TadsVersion != null)
                w.Write(" from TADS version " + TadsVersion);
